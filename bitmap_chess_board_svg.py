...
def extract_piece_images(sheet_path):
    """Extracts each piece from the provided PNG image and returns a dict."""
...
def draw_board_with_pieces(fen, piece_images, square_size, out_path=OUTPUT_IMAGE):
...
def main():
    ...
    draw_board_with_pieces(START_FEN, piece_images, piece_size)
