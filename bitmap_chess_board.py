...
OUTPUT_IMAGE = 'bitmap_chess_board_start.png'
...
def extract_piece_images(sheet_path):
    """Extracts each piece from the provided image and returns a dict."""
...
def draw_board_with_pieces(fen, piece_images, square_size=SQUARE_SIZE, out_path=OUTPUT_IMAGE):
    ...
    print(f"Chess board image saved as {out_path}")

def main():
    piece_images = extract_piece_images(PIECE_IMAGE)
    draw_board_with_pieces(START_FEN, piece_images)
